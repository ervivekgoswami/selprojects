package com.navistar.occ.testbase;
...
import com.navistar.occ.customelistener.Listner;
...
public class TestBase {
	...
	static {
		...
		extent = new ExtentReports(System.getProperty("user.dir") + "/src/test/java/com/navsitar/occ/reports/occ_test_" + formater.format(calendar.getTime()) + ".html", false);
	}
	...
	public void loadPropertiesFile() throws IOException {
		f = new File(System.getProperty("user.dir") + "//src//test//java//com//navistar//occ//config//config.properties");
	...
	public void getScreenShotFromOCC(String name) {
		...
		try {
			String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath() + "/src/java/test/com/navistar/occ/screenshots/";
	...
	public  void getScreenShot(String fileName) throws IOException {
		...
		FileUtils.copyFile(outputFile, new File(System.getProperty("user.dir") + "//src//test//java//com//navistar//occ//screenshots//" + fileName + ".jpg"));
	}
	...
	public static void updateResult(int indexSI, String testCaseName, String testCaseStatus, String scriptName) throws IOException {
		...
		String resultFile = userDirector + "//src//test//java//com//navistar//occ//report//OCCAutomationReport.html";
	...
	public String captureScreen(String fileName) {
		...
		try {
			String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath() + "/src/test/java/com/navistar/occ/screenshots/";
