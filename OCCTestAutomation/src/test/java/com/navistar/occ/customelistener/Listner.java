package com.navistar.occ.customelistener;
import java.io.File;
...
public class Listner extends TestBase implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		if(!result.isSuccess()){
			...
			try {
				String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath() + "/src/java/test/com/navistar/occ";
	...
	public void onTestSuccess(ITestResult arg0) {
		...
		if(arg0.isSuccess()){
			...
			try {
				...
				System.out.println("destFile............."+(String) reportDirectory + "success_screenshots/" + methodName + "_" + formater.format(calendar.getTime()) + ".png");
				FileUtils.copyFile(scrFile, destFile);
